...
#ifndef TALOS_DATA_DEPRECATED_HH
# define TALOS_DATA_DEPRECATED_HH
...
//  void foo () TALOS_DATA_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar TALOS_DATA_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a TALOS_DATA_DEPRECATED = 0;
//
...
#  define TALOS_DATA_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define TALOS_DATA_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define TALOS_DATA_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! TALOS_DATA_DEPRECATED_HH
