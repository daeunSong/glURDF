...
#ifndef TALOS_DATA_WARNING_HH
# define TALOS_DATA_WARNING_HH

// Emits a warning in a portable way.
//
// To emit a warning, one can insert:
//
// #pragma message TALOS_DATA_WARN("your warning message here")
//
...
# define TALOS_DATA_WARN_STRINGISE_IMPL(x) #x
# define TALOS_DATA_WARN_STRINGISE(x) \
         TALOS_DATA_WARN_STRINGISE_IMPL(x)
# ifdef __GNUC__
#   define TALOS_DATA_WARN(exp) ("WARNING: " exp)
# else
#  ifdef _MSC_VER
#   define FILE_LINE_LINK __FILE__ "(" \
           TALOS_DATA_WARN_STRINGISE(__LINE__) ") : "
#   define TALOS_DATA_WARN(exp) (FILE_LINE_LINK "WARNING: " exp)
#  else
// If the compiler is not recognized, drop the feature.
#   define TALOS_DATA_WARN(MSG) /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! TALOS_DATA_WARNING_HH
