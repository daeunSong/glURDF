...
IF(NOT EXISTS "/home/daeunsong/devel/hpp/src/talos-data/build-rel/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/home/daeunsong/devel/hpp/src/talos-data/build-rel/install_manifest.txt\"")
ENDIF(NOT EXISTS "/home/daeunsong/devel/hpp/src/talos-data/build-rel/install_manifest.txt")

MESSAGE(STATUS "catkin path: /usr/local/.catkin")
IF(EXISTS "/usr/local/.catkin")
  MESSAGE(STATUS "Try to remove /usr/local/.catkin")
  EXECUTE_PROCESS(
      COMMAND /usr/local/bin/cmake -E remove "/usr/local/.catkin"
...
FILE(READ "/home/daeunsong/devel/hpp/src/talos-data/build-rel/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/local/bin/cmake" -E remove "/home/daeunsong/devel/hpp/src/talos-data/build-rel/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
