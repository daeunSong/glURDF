...
set("talos_data_INCLUDE_DIRS" "/usr/local/include")
set("TALOS_DATA_INCLUDE_DIRS" "/usr/local/include")
set("talos_data_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/talos_data/doxygen-html")
set("TALOS_DATA_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/talos_data/doxygen-html")
set("talos_data_DEPENDENCIES" "urdfdom;gazebo;roscpp")
set("talos_data_PKG_CONFIG_DEPENDENCIES" "")
...
set("talos_data_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("TALOS_DATA_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})

include(CMakeFindDependencyMacro)
find_dependency(urdfdom REQUIRED)
find_dependency(gazebo REQUIRED)
find_dependency(roscpp)

IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${talos_data_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/talos_dataTargets.cmake")
check_required_components("talos_data")

set(TALOS_DATA_PREFIX /usr/local)
